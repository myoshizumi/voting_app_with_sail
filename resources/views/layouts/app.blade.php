...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans bg-gray-background text-gray-900 text-sm">
        ...
        <main class="container mx-auto max-w-custom flex" style="max-width:1000px">
            <div class="w-70 mr-5">Add idea form goes here. Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum voluptatem expedita aut repudiandae! Alias dolor perspiciatis ducimus repellendus, officiis inventore ipsum consequuntur maxime eos quos. Placeat eum minima, deserunt iste dignissimos doloremque veritatis reiciendis sint laborum quibusdam animi doloribus quos.</div>
            <div class="w-175">
