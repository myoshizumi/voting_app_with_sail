            ...
            <div class="w-70 mr-5">
                <div class="bg-white border-2 border-blue rounded-xl mt-16"
                    ...
                    <form action="#" method="POST" class="space-y-4 px-4 py-6">
                        ...
                        <div class="">
                            <textarea name="idea" id="idea" cols="30" rows="4" class="bg-gray-100 w-full px-4 py-7 rounded-xl borde-none placeholder-gray-900 text-sm" placeholder="Describe your idea"></textarea>
                        </div>
