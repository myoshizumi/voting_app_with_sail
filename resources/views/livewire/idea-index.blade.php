...
>
    <div class="hidden md:block border-r border-gray-100 px-5 py-8">
        ...
        <div class="mt-8">
            @if ($hasVoted)
                <button class="w-20 text-white bg-blue border border-blue hover:bg-blue-hover font-bold text-xss uppercase rounded-xl transition duration ease-in px-4 py-3">Voted</button>
            @else
        ...
        <div class="w-full mx-2 md:mx-4 flex flex-col justify-between">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                ...
                class="flex items-center space-x-2 mt-4 md:mt-0">
                    <div class="{{ Str::kebab($idea->status->name) }} text-xxs font-bold uppercase leading-none rounded-full text-center w-12 md:w-full h-7 py-2 px-4">
                        {{ $idea->status->name }}
                    </div>
                    <button 
                    @click="isOpen = !isOpen"
                ...
                <div class="flex items-center md:hidden mt-4 md:mt-0">
                    ...
                    @if ($hasVoted)
                    <button class="w-20 text-white bg-blue border border-blue font-bold text-xxs uppercase rounded-xl hover:bg-blue-hover transition duration-150 ease-in px-4 py-3 -mx-5">
                        Vote
                    </button>
