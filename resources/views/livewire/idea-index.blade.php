    ...
    <div class="hidden md:block border-r border-gray-100 px-5 py-8">
        ...
        <div class="mt-8">
            @if ($hasVoted)
                ...
                class="w-20 text-white bg-blue border border-blue hover:bg-blue-hover font-bold text-xss uppercase rounded-xl transition duration ease-in px-4 py-3">Voted</button>
            @else
                <button
                wire:click.prevent="vote"
                class="w-20 bg-gray-200 border border-gray-200 hover:border-gray-400 font-bold text-xss uppercase rounded-xl transition duration ease-in px-4 py-3">Vote</button>
            @endif
        </div>
    </div>
