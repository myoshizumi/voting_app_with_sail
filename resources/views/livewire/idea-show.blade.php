                ...
                <div class="w-full mx-2 md:mx-4">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                        ...
                        <div
                            ...
                            x-data="{ isOpen: false }"
                        >
                            <div class="{{ Str::kebab($idea->status->name) }} text-xxs font-bold uppercase leading-none rounded-full text-center w-full h-7 py-2 px-4">{{ $idea->status->name }}</div>
                            <div class="relative">
                                <button
                        ...
                        <div class="flex items-center md:hidden mt-4 md:mt-0">
                            <div class="bg-gray-100 text-center rounded-xl h-12 px-4 py-2 pr-8">
            ...
            <div class="hidden md:flex items-center space-x-3">
                ...
                @if ($hasVoted)
                    <button
                        wire:click.prevent="vote"
                        type="button"
                        class="w-32 h-11 text-white text-xs bg-blue font-semibold uppercase rounded-xl border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3"
                    >
                        <span>Voted</span>
                    </button>
                @else     
