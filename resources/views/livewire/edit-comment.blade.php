      ...
      <div 
        ...
        <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
            ...
            <form wire:submit.prevent="updateComment" action="#" method="POST" class="space-y-4 px-4 py-6">
                <div>
                    <textarea x-ref="editComment" wire:model.defer="body" name="idea" cols="30" rows="4" class="bg-gray-100 w-full px-4 py-7 rounded-xl borde-none placeholder-gray-900 text-sm" placeholder="Type your comment here" required></textarea>
                    @error('body')
