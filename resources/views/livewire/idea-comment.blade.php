    ...
    <div class="flex flex-col md:flex-row flex-1 px-4 py-6">
        ...
        <div class="w-full md:mx-4"> 
            <div class="text-gray-600">
                ...
                <h4 class="text-xl font-semiboldmb-3">
            ...
            <div class="flex items-center justify-between mt-6">
                <div class="flex items-center text-xs text-gray-400 font-semibold space-x-2">
                    <div class="{{  $comment->is_status_update ? "text-blue" :  "text-gray-900"  }} font-bold">{{ $comment->user->name }}</div>
                ...
                >
                    <div class="relative">
                        ...
                        <ul
                            class="absolute w-44  text-left font-semibold text-gray-900 bg-white shadow-dialog rounded-xl z-10 py-3 md:ml-8 top-8 md:top-6 right-0 md:left-0"
                            x-cloak
                        ...
                        >
                            ...
                            <li><a href="#" 
                                @click.prevent="
                                    ...
                                    "
                                class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3">Edit Comment</a>
                            </li>
                            @endcan
                            ...
                            <li><a href="#" 
                                @click.prevent="
                                    ...
                                    "
                                class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3">Delete Comment</a>
                            </li>
                            @endcan
