...
class CommentsSpamManagementTest extends TestCase
{
     ...
     * @comment
     */
    public function marking_a_comment_as_spam_show_on_menu_when_user_has_authorization()
    {
        $user = User::factory()->create();
        $idea = Idea::factory()->create();
     ...
     * @comment
     */
    public function marking_a_comment_as_spam_does_not_show_when_user_does_not_have_authorization()
    {
        $user = User::factory()->create();
        $idea = Idea::factory()->create();
